...
const docTemplate = `{
        ...
        "/experiments": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search term to filter experiments by title",
                        "name": "search",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/root.ExperimentsResponseDto"
                                            }
                                        }
                                    }
                                }
                    ...
                    "500": {
                        "description": "Failed to get experiments",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponse"
                        }
                    }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Experiment creation details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/root.CreateExperimentDto"
                        }
                    }
                ],
                "responses": {
        ...
        "/experiments/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Experiment ID (UUID format)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/root.ExperimentResponseDto"
                                        }
                                    }
                                }
                            ]
                    ...
                    "500": {
                        "description": "Failed to get experiment",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponse"
                        }
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/root.UpdateExperimentDto"
                        }
                    }
                ],
                "responses": {
        ...
        "/permission-groups": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search term to filter permission groups by name",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        ...
                        "description": "Filter by permission IDs (UUID format)",
                        "name": "permissions",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/permission.PermissionGroupResponseDto"
                                            }
                                        }
                                    }
                                }
                    ...
                    "400": {
                        "description": "Invalid pagination parameters or permission IDs",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponse"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/permission.CreatePermissionGroupDto"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request format or invalid permissions",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponse"
                        }
                    },
        ...
        "/permission-groups/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Permission Group ID (UUID format)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Permission group fetched successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.SuccessResponse"
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated permission group details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/permission.UpdatePermissionGroupDto"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid ID format or invalid permissions",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponse"
                        }
                    },
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to delete permission group or cannot delete Super Admin",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponse"
                        }
                    }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/permission.PermissionResponseDto"
                                            }
                                        }
                                    }
                                }
        ...
        "/permissions/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Permission ID (UUID format)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/users": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid username or invalid permissions",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponse"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.DeleteUsersDto"
                        }
                    }
                ],
                "responses": {
        ...
        "/users/{id}": {
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid user ID, invalid username, or invalid permissions",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponse"
                        }
                    },
    ...
    "definitions": {
        ...
        "permission.CreatePermissionGroupDto": {
            "type": "object",
            "required": [
                "name",
                "permissions"
        ...
        "permission.PermissionGroupResponseDto": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "permission.UpdatePermissionGroupDto": {
            "type": "object",
            "required": [
                "permissions"
            ],
        ...
        "user.PermissionGroupResponseDto": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
                ...
                "permissions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/user.PermissionResponseDto"
                    }
                }
            }
        },
        "user.PermissionResponseDto": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "user.UserResponseDto": {
            ...
            "properties": {
                ...
                "permission_groups": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/user.PermissionGroupResponseDto"
                    }
                },
                "username": {
                    "type": "string"

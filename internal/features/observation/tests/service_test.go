...
func TestService_GetAllObservations(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedResult: observation.MapObservationsToDto(TestObservationMetadataList(3)),
			expectedLength: 3,
			expectedError:  nil,
		},
		{
			...
			expectedResult: observation.MapObservationsToDto(TestObservationMetadataList(2)),
			expectedLength: 2,
			expectedError:  nil,
		},
		{
			...
			expectedResult: observation.MapObservationsToDto(TestObservationMetadataList(1)),
			expectedLength: 5,
			expectedError:  nil,
		},
		{

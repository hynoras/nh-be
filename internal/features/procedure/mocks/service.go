...
// GetAllProcedures provides a mock function with given fields: ctx, search, page, pageSize
func (_m *Service) GetAllProcedures(ctx context.Context, search string, page int, pageSize int) ([]procedure.ProcedureListResponseDto, int64, error) {
...
//   - page int
//   - pageSize int
func (_e *Service_Expecter) GetAllProcedures(ctx interface{}, search interface{}, page interface{}, pageSize interface{}) *Service_GetAllProcedures_Call {
	return &Service_GetAllProcedures_Call{Call: _e.mock.On("GetAllProcedures", ctx, search, page, pageSize)}
}

func (_c *Service_GetAllProcedures_Call) Run(run func(ctx context.Context, search string, page int, pageSize int)) *Service_GetAllProcedures_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
// GetProcedureSteps provides a mock function with given fields: ctx, procedureId, page, pageSize
func (_m *Service) GetProcedureSteps(ctx context.Context, procedureId uuid.UUID, page int, pageSize int) ([]procedure.StepsResponseDto, int64, error) {
...
//   - page int
//   - pageSize int
func (_e *Service_Expecter) GetProcedureSteps(ctx interface{}, procedureId interface{}, page interface{}, pageSize interface{}) *Service_GetProcedureSteps_Call {
	return &Service_GetProcedureSteps_Call{Call: _e.mock.On("GetProcedureSteps", ctx, procedureId, page, pageSize)}
}

func (_c *Service_GetProcedureSteps_Call) Run(run func(ctx context.Context, procedureId uuid.UUID, page int, pageSize int)) *Service_GetProcedureSteps_Call {
	_c.Call.Run(func(args mock.Arguments) {

...
func (_m *Repository) FindAll(ctx context.Context, search string, page int, pageSize int) ([]procedure.Procedure, int64, error) {
...
// GetProcStepsByProcID provides a mock function with given fields: ctx, procedureId, page, pageSize
func (_m *Repository) GetProcStepsByProcID(ctx context.Context, procedureId uuid.UUID, page int, pageSize int) ([]procedure.ProcedureStep, int64, error) {
	ret := _m.Called(ctx, procedureId, page, pageSize)
	...
	if rf, ok := ret.Get(1).(func(context.Context, uuid.UUID, int, int) int64); ok {
		r1 = rf(ctx, procedureId, page, pageSize)
	} else {
		r1 = ret.Get(1).(int64)
	}

	if rf, ok := ret.Get(2).(func(context.Context, uuid.UUID, int, int) error); ok {
		r2 = rf(ctx, procedureId, page, pageSize)
	} else {
		r2 = ret.Error(2)
	}
...
//   - page int
//   - pageSize int
func (_e *Repository_Expecter) GetProcStepsByProcID(ctx interface{}, procedureId interface{}, page interface{}, pageSize interface{}) *Repository_GetProcStepsByProcID_Call {
	return &Repository_GetProcStepsByProcID_Call{Call: _e.mock.On("GetProcStepsByProcID", ctx, procedureId, page, pageSize)}
}

func (_c *Repository_GetProcStepsByProcID_Call) Run(run func(ctx context.Context, procedureId uuid.UUID, page int, pageSize int)) *Repository_GetProcStepsByProcID_Call {
	_c.Call.Run(func(args mock.Arguments) {
